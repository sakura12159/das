...
class MainWindow(QMainWindow):
    ...
    def initMenu(self):
        ...
        # Operation
        self.operation_menu = createMenu('Operation', self.menu_bar, enable=False)
        ...
        # Plot
        self.plot_menu = createMenu('Plot', self.menu_bar, enable=False)
        ...
        # Filter
        self.filter_menu = createMenu('Filter', self.menu_bar, enable=False)
    ...
    def initTabWidget(self):
        ...
        # 绘制灰度图
        self.plot_gray_scale_widget = MyPlotWidget('Gray Scale', 'Time(s)', 'Channel', image=True)
    ...
    def plotGrayChannelsTime(self):
        ...
        self.plot_gray_scale_widget.setXRange(self.sampling_times_from_num / self.sampling_rate,
                                              self.sampling_times_to_num / self.sampling_rate)
        self.plot_gray_scale_widget.setYRange(0, self.current_channels)
        item = pg.ImageItem()
    ...
    def changeChannelNumber(self):
        ...
        self.channel_number = 0 if self.channel_number_spinbx.value() == '' else self.channel_number_spinbx.value()
    ...
    def plotBinaryImage(self):
        ...
        binary_image_widget = MyPlotWidget('Binary Image', 'Time(s)', 'Channel', image=True)
    ...
    def plotMultiChannelImage(self):
        ...
        plot_widget = MyPlotWidget('MultiChannel Image', 'Time(s)', 'Channel', clear_plot=False)
        ...
        for i in range(self.current_channels):
            plot_widget.draw(x, self.data[i] + i, pen=QColor(next(colors)))  # 根据通道数个位选择颜色绘图
